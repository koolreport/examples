Excel package of KoolReport is able to export data from database or any other kinds of datasource to excel file. Only that, it is able to create charts and graphs in excel files.
